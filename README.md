...
Wang YJ, Lin MW, Lin AA, Wu SN. Riluzole-induced block of voltage-gated Na(+) current and activation of BK(Ca) channels in cultured differentiated human skeletal muscle cell.
...
![screenshot](./SkM_AP.JPG)

To mimic the riluzole action, changes in the parameters of gNa and gK(Ca) will make traces similar to Fig. 6B or 6C.
